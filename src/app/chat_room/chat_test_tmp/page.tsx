    ...
    <div className=" w-screen h-screen  dark:bg-gray-900 dark:text-white bg-gray-white text-gray-900">
        ...
        <div className="w-full h-full flex flex-row ">
          ...
          <div className="w-full h-full flex md:flex-row flex-col">
            ...
            <div className="w-[60px] h-full hidden md:block"> <TopBar /></div>
            <div className="hidden  C-con h-full md:flex md:flex-row">
          <Chat_msg />
          </div>
            <div className="hidden w-[300px] h-full md:flex md:flex-row overflow-y-auto">
          <Contents_trend />
          </div>
